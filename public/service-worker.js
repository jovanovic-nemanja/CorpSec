...
/******/ 	return __webpack_require__(__webpack_require__.s = "./resources/js/service-worker/source-sw.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./resources/js/service-worker/cache.js":
/*!**********************************************!*\
  !*** ./resources/js/service-worker/cache.js ***!
  \**********************************************/
/*! no exports provided */
...
/* harmony import */ var workbox_cacheable_response__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! workbox-cacheable-response */ "./node_modules/workbox-cacheable-response/index.mjs");
...
Object(workbox_core__WEBPACK_IMPORTED_MODULE_1__["setCacheNameDetails"])({
  prefix: _js_vars__WEBPACK_IMPORTED_MODULE_0__["default"].serviceWorkerKey.toLowerCase(),
  suffix: _js_vars__WEBPACK_IMPORTED_MODULE_0__["default"].serviceWorkerVersion
});
Object(workbox_precaching__WEBPACK_IMPORTED_MODULE_2__["precacheAndRoute"])([] || []); // fonts
// 
...
Object(workbox_routing__WEBPACK_IMPORTED_MODULE_3__["registerRoute"])(new RegExp('.(?:png|gif|jpg|jpeg|webp|svg|ico)$'), new workbox_strategies__WEBPACK_IMPORTED_MODULE_4__["CacheFirst"]({
...
Object(workbox_routing__WEBPACK_IMPORTED_MODULE_3__["registerRoute"])(new RegExp('(?:lang)$'), new workbox_strategies__WEBPACK_IMPORTED_MODULE_4__["StaleWhileRevalidate"]({
  cacheName: 'static-resources'
})); // static

Object(workbox_routing__WEBPACK_IMPORTED_MODULE_3__["registerRoute"])(new RegExp('.(?:js|css)$'), new workbox_strategies__WEBPACK_IMPORTED_MODULE_4__["StaleWhileRevalidate"]({
  cacheName: 'static-resources'
}));
Object(workbox_routing__WEBPACK_IMPORTED_MODULE_3__["registerRoute"])(new RegExp('.*\/api\/.*$'), new workbox_strategies__WEBPACK_IMPORTED_MODULE_4__["NetworkFirst"]({
...
Object(workbox_routing__WEBPACK_IMPORTED_MODULE_3__["setCatchHandler"])(function (_ref) {
  ...
  switch (event.request.destination) {
    case 'document':
      ...
      return caches.match(Object(workbox_precaching__WEBPACK_IMPORTED_MODULE_2__["getCacheKeyForURL"])('/offline.html'));
      break;
...
/***/ "./resources/js/service-worker/config.js":
/*!***********************************************!*\
  !*** ./resources/js/service-worker/config.js ***!
  \***********************************************/
...
/***/ "./resources/js/service-worker/source-sw.js":
/*!**************************************************!*\
  !*** ./resources/js/service-worker/source-sw.js ***!
  \**************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config */ "./resources/js/service-worker/config.js");
/* harmony import */ var _cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cache */ "./resources/js/service-worker/cache.js");
/* harmony import */ var _js_vars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @js/vars */ "./resources/js/vars.js");



var SW_VERSION = _js_vars__WEBPACK_IMPORTED_MODULE_2__["default"].serviceWorkerKey + '-' + _js_vars__WEBPACK_IMPORTED_MODULE_2__["default"].serviceWorkerVersion;
...
/*!******************************!*\
  !*** ./resources/js/vars.js ***!
  \******************************/
/*! exports provided: vars, updateVars, fileIcons, fileMimeTypes, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "vars", function() { return vars; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateVars", function() { return updateVars; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fileIcons", function() { return fileIcons; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fileMimeTypes", function() { return fileMimeTypes; });
...
var datepickerRangeConfig = _objectSpread(_objectSpread({}, datepickerConfig), {}, {
  mode: 'range'
});

var datepickerMultipleConfig = _objectSpread(_objectSpread({}, datepickerConfig), {}, {
  mode: 'multiple'
});
...
var onMonthOrYearChange = function onMonthOrYearChange(dObj, dStr, fp) {
...
var keepAddingOptions = [{
  uuid: 'clear_all',
  name: 'clear_all'
}, {
  uuid: 'clear_all_but_selected',
  name: 'clear_all_but_selected'
}, {
  uuid: 'clear_only_selected',
  name: 'clear_only_selected'
}];
var momentCalendarShortLocale = {
  lastDay: 'Yesterday',
  sameDay: 'LT',
  lastWeek: 'll',
  sameElse: 'll'
};
var APP_NAME = 'KodeMint';
...
var updateVars = function updateVars() {
  ...
  var keyName = domainUrl + '_' + APP_NAME + '_' + APP_ENV;
