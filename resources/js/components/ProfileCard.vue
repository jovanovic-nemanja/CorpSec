<template>
    <div :class="['profile-card', {'horizontal-layout': horizontal}]">
        ...
        <div class="profile-details-wrapper">
            ...
            <div class="profile-details">
                ...
                <p class="profile-extras text-muted comma-list" v-if="!$slots.extras">
                    <span v-if="gender">{{ gender.name }}</span>
                    <span v-if="age">{{ $t('global.years_old', { attribute: age.years }) }}</span>
                </p>
                <div class="profile-extras has-slot" v-else>
                    <slot name="extras" />
                </div>
            </div>
        </div>

        <profile-buttons v-if="showButtons" :link="to" :user="user" @buttonClicked="$emit('buttonClicked')" />
